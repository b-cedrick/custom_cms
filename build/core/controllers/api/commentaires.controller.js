...
var commentaires_model_1 = require("../../models/commentaires.model");
var CommentairesController = /** @class */ (function () {
    ...
    CommentairesController.getAllCommentaires = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CommentairesController.addCommentaire = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, commentaires_model_1.commentaire.add(data)
    ...
    CommentairesController.updateCommentaires = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, commentaires_model_1.commentaire.update(data)];
                    case 1:
                        res = _a.sent();
    ...
    CommentairesController.deleteCommentaires = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, commentaires_model_1.commentaire.delete(data)
                        // console.log({success: true, message: "Commentaire supprimé avec succès"})        
                    ];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, { success: true, message: "Commentaire supprimé avec succès" }];
                    case 2: 
                    // console.log({success: true, message: "Commentaire supprimé avec succès"})        
                    return [2 /*return*/, _a.sent()];
                }
    ...
    return CommentairesController;
}());
exports.default = CommentairesController;
