...
var ArticlesController = /** @class */ (function () {
    ...
    ArticlesController.getArticle = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, articles_models_1.article.selectFields(['_id', 'title', 'content']).findById(id)];
    ...
    ArticlesController.addArticle = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, articles_models_1.article.add(data)
    ...
    ArticlesController.updateArticles = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, articles_models_1.article.update(data)];
                    case 1:
                        res = _a.sent();
    ...
    ArticlesController.deleteArticles = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, articles_models_1.article.delete(data)
